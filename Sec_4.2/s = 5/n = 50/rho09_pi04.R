...
pdf(paste("fig_n50_rho09_pi04.pdf" ), width = 5, height = 5)

plot(fpr[1:400], tpr[1:400], type = "l", lwd = 2, xlab = "False positive rate" ,
ylim = c(0,1.2), xlim = c(0, 0.25), ylab = "True positive rate",
...
legend(x = 0.075, y = 1.22, c("(AUC = 0.741)", "(AUC = 0.675)", "(AUC = 0.676)", "(AUC = 0.664)"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)
