...
pdf("fig_s10_n150_rho09_pi02.pdf", width = 5, height = 5)

plot(fpr, tpr, type = "l", ylim = c(0, 1.4), xlim = c(0,new_fpr),
xlab = "False positive rate", ylab = "True positive rate", main = expression(rho==0.9 ~~ and ~~ pi==0.2),
...
legend(x = 0.32 * new_fpr , y = 1.42, c("(AUC = 0.851)", "(AUC = 0.777)", "(AUC = 0.774)", "(AUC = 0.777)"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)
