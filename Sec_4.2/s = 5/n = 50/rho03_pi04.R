...
pdf(paste("fig_n50_rho03_pi04.pdf" ), width = 5, height = 5)

plot(fpr[1:400], tpr[1:400], type = "l", lwd = 2, xlab = "False positive rate" ,
ylim = c(0,1.2), xlim = c(0, 0.33), ylab = "True positive rate",
...
legend(x = 0.10, y = 1.22, c("(AUC = 0.703)", "(AUC = 0.679)", "(AUC = 0.679)", "(AUC = 0.686)"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)
