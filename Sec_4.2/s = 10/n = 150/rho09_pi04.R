...
pdf("fig_s10_n150_rho09_pi04.pdf", width = 5, height = 5)

plot(fpr, tpr, type = "l", ylim = c(0, 1.4), xlim = c(0,new_fpr),
xlab = "False positive rate", ylab = "True positive rate", main = expression(rho==0.9 ~~ and ~~ pi==0.4),
lwd = 2, cex.main = 1.75, cex.lab = 1.3, col = "gray0", axes = FALSE)
axis(1)
...
legend(x = -0.005, y = 1.42, c("dgCox", "CoxNet", "CoxPath", "CoxPen"),
lwd = 2, lty = 1:4, col = c("gray0", "gray25", "gray50", "gray75"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)

legend(x = 0.32 * new_fpr , y = 1.42, c("(AUC = 0.802)", "(AUC = 0.714)", "(AUC = 0.715)", "(AUC = 0.717)"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)
