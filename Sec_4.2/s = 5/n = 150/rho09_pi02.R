...
pdf(paste("fig_n150_rho09_pi02.pdf" ),width=5,height=5)

plot(fpr, tpr, type = "l", ylim = c(0,1.2), xlim = c(0,new_fpr),
...
legend(x = 0.17, y = 1.22, c("(AUC = 0.828)", "(AUC = 0.759)", "(AUC = 0.766)", "(AUC = 0.761)"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)
