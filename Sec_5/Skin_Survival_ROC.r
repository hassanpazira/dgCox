...
## Test
W_test = X[test,gene.sel]%*%as.matrix(out.dgcoxph.train$beta[,which.min(GIC_bic.train)])
...
#### Final Plot
pdf("Skin-survival-roc.pdf",width=6,height=6)
