...
pdf(paste("fig_s10_n50_rho09_pi04.pdf" ), width = 5, height = 5)

plot(fpr[1:400], tpr[1:400], type = "l", lwd = 2, xlab = "False positive rate" ,
ylim = c(0,1.2), xlim = c(0, new_fpr), ylab = "True positive rate",
main= expression(rho==0.9 ~~ and ~~ pi==0.4), cex.main = 1.75, cex.lab = 1.3, col = "gray0", axes = FALSE)
axis(1)
...
legend(x = 0.062, y = 1.22, c("(AUC = 0.767)", "(AUC = 0.686)", "(AUC = 0.683)", "(AUC = 0.685)"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)
