...
pdf(paste("fig_n150_rho06_pi02.pdf" ),width=5,height=5)

plot(fpr, tpr, type = "l", lwd=2, xlab = "False positive rate", ylim = c(0,1.45), xlim = c(0,new_fpr),
...
legend(x = 0.24, y = 1.47, c("(AUC = 0.895)", "(AUC = 0.865)", "(AUC = 0.872)", "(AUC = 0.862)"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)
