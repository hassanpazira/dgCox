...
pdf("fig_n150_rho03_pi02.pdf", width = 5, height = 5)

plot(fpr, tpr, type = "l", ylim = c(0,1.5), xlim = c(0,0.8),
...
legend(x = 0.25, y = 1.52, c("(AUC = 0.899)", "(AUC = 0.877)", "(AUC = 0.676)", "(AUC = 0.873)"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)
