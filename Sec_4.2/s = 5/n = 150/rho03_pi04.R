...
pdf(paste("fig_n150_rho03_pi04.pdf" ), width = 5, height = 5)

plot(fpr[1:400], tpr[1:400], type = "l", lwd = 2, xlab = "False positive rate" ,
ylim = c(0,1.5), xlim = c(0, 0.41), ylab = "True positive rate",
main= expression(rho==0.3 ~~ and ~~ pi==0.4), cex.main = 1.75, cex.lab = 1.3, col = "gray0", axes = FALSE)
axis(1)
...
legend(x = -0.005, y = 1.52, c("dgCox", "CoxNet", "CoxPath", "CoxPen"),
lwd = 2, lty = 1:4, col = c("gray0", "gray25", "gray50", "gray75"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)

legend(x = 0.125, y = 1.52, c("(AUC = 0.854)", "(AUC = 0.833)", "(AUC = 0.835)", "(AUC = 0.831)"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)
