...
pdf(paste("fig_s10_n50_rho09_pi02.pdf" ),width=5,height=5)

plot(fpr, tpr, type = "l", ylim = c(0,1.2), xlim = c(0,0.2),
...
legend(x = 0, y = 1.22, c("dgCox", "CoxNet", "CoxPath", "CoxPen"),
lwd = 2, lty = 1:4, col = c("gray0", "gray25", "gray50", "gray75"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)

legend(x = 0.065, y = 1.22, c("(AUC = 0.770)", "(AUC = 0.749)", "(AUC = 0.743)", "(AUC = 0.750)"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)
