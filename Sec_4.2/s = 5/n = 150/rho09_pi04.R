...
pdf(paste("fig_n150_rho09_pi04.pdf" ), width = 5, height = 5)

plot(fpr[1:400], tpr[1:400], type = "l", lwd = 2, xlab = "False positive rate" ,
ylim = c(0,1.2), xlim = c(0, 0.28), ylab = "True positive rate",
...
legend(x = 0.085, y = 1.22, c("(AUC = 0.801)", "(AUC = 0.722)", "(AUC = 0.725)", "(AUC = 0.720)"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)
