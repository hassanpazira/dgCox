...
pdf(paste("fig_n150_rho06_pi04.pdf" ), width = 5, height = 5)

plot(fpr[1:400], tpr[1:400], type = "l", lwd = 2, xlab = "False positive rate" ,
ylim = c(0,1.45), xlim = c(0, 0.5), ylab = "True positive rate",
main= expression(rho==0.6 ~~ and ~~ pi==0.4), cex.main = 1.75, cex.lab = 1.3, col = "gray0", axes = FALSE)
axis(1)
...
legend(x = -0.005, y = 1.47, c("dgCox", "CoxNet", "CoxPath", "CoxPen"),
lwd = 2, lty = 1:4, col = c("gray0", "gray25", "gray50", "gray75"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)

legend(x = 0.155, y = 1.47, c("(AUC = 0.886)", "(AUC = 0.841)", "(AUC = 0.846)", "(AUC = 0.835)"),
box.lwd = 0, box.col = "white", bg = "white", bty = "n", cex = 1.1)
